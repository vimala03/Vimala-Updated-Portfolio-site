      ...
      <div className="max-w-[1440px] mx-auto px-[60px]">
        <div className="px-[91px]">
          <div className="flex items-center justify-between gap-12">
            ...
            {/* Left — text content */}
            <div className="flex flex-col gap-9 max-w-[537px] w-full shrink-0">
              <AnimateIn delay={0}>
                <div className="flex flex-col gap-9">
                  ...
                  {/* Heading */}
                  <h1 className="font-cormorant font-medium text-[48px] text-[#18181b] leading-[1.05] tracking-[-0.63px]">
                    Designing products.{' '}
                  ...
                  {/* Paragraph */}
                  <p className="font-inter font-normal text-[17px] text-[rgba(24,24,27,0.55)] leading-[28.9px] tracking-[-0.085px] max-w-[506px]">
            ...
            {/* Right — hero image */}
            <AnimateIn delay={120} className="shrink-0">
              <div className="border border-[rgba(24,24,27,0.08)] rounded-[20px] shadow-[0px_8px_32px_0px_rgba(0,0,0,0.07)] overflow-hidden w-[422px] h-[395px]">
                <img
                  src={imgHero}
                  alt="Vimala Banavath"
