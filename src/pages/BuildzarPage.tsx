...
export default function BuildzarPage() {
  return (
    <div>
      ...
      <Link
        to="/work/moonraft"
        aria-label="Go to next case study: Moonraft – UST Global"
      ...
      >
        <div style={{ padding: "4rem", background: "var(--bg2, #f4f3f0)", borderTop: "0.5px solid rgba(24,24,27,0.1)", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "2rem", cursor: "pointer" }}>
          <div>
            ...
            <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.6rem", letterSpacing: "-0.02em", color: "#18181b" }}>Moonraft – UST Global</div>
          </div>
